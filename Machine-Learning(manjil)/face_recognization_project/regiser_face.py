...
# ENCODING_FILE = os.path.join(DATASET_DIR, "encodings.pkl")
...
# # create  subfolder directory with user name
# user_dir = os.path.join(DATASET_DIR, name)
# if not os.path.exists(user_dir):
#     os.makedirs(user_dir)

# cap = cv2.VideoCapture(0)
# print("Entre 'c' for capture image, 'q' for quit")
# counter = 0
# while True:
#     ret, frame = cap.read()
#     if not ret:
...
#         break
#     cv2.imshow("Redistered frame", frame)
...
Features:
 ...
 - Store user images in dataset/username/username1.png 
...
# Dataset and encoding file inside the project
DATASET_DIR = os.path.join(BASE_DIR, "dataset")
...
print("Encoding done and saved inside project folder")
